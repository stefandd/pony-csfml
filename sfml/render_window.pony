...
use @sfRenderWindow_drawSprite[None](window: _RenderWindowRaw box, sprite: _SpriteRaw, states: _RenderStatesRaw box)
use @sfRenderWindow_drawShape[None](window: _RenderWindowRaw box, shape: ShapeRaw box, states: _RenderStatesRaw box)
use @sfRenderWindow_drawText[None](window: _RenderWindowRaw box, text: TextRaw box, states: _RenderStatesRaw box)
