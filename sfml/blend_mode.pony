...
class BlendMode
    ...
    =>
        ...
        _adf = alphaDstFactor
        _aeq = alphaEquation
        _csfml = _BlendMode(_csf, _cdf, _ceq, _asf, _adf, _aeq)
    ...
    fun ref setColorSrcFactor(x: BlendModeFactor)   => _csf = x ; _csfml.csf = x()
    fun ref setColorDstFactor(x: BlendModeFactor)   => _cdf = x ; _csfml.cdf = x()
    fun ref setColorEquation(x:  BlendModeEquation) => _ceq = x ; _csfml.ceq = x()
    fun ref setAlphaSrcFactor(x: BlendModeFactor)   => _asf = x ; _csfml.asf = x()
    fun ref setAlphaDstFactor(x: BlendModeFactor)   => _adf = x ; _csfml.adf = x()
    fun ref setAlphaEquation(x:  BlendModeEquation) => _aeq = x ; _csfml.aeq = x()
